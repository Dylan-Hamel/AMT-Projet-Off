...
public class ServletAdministrator extends javax.servlet.http.HttpServlet {
    ...
    protected void doPost (javax.servlet.http.HttpServletRequest request,
        ...
        if (ckDelete != null){
            ...
            System.out.println("[ServletAdministrator - doPost] delete ? - " + deleteSQL);
            if(!deleteSQL) {
                errorMessage += "Account has been not deleted \n";
            }else {

                System.out.println("[ServletAdministrator - doPost] sendEmail  - " + email);
                User user = userDao.getUserWithID(email);

                System.out.println("[ServletAdministrator - doPost] user null ? - " + (user != null));
                if (user != null) {
            ...
            if (ckResetPW != null) {
                ...
                boolean enableSQL = userDao.setUserResetTo1(email);
        ...
        System.out.println("[ServletAdministrator - doPost] sendRedirect");
