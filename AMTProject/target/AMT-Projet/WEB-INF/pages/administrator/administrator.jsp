...
<head>
    ...
    <!-- Title Page-->
    <title>AMT-Project - Administrator</title>

    <style type="text/css">
        <jsp:include page="/WEB-INF/pages/profil/vendor/mdi-font/css/material-design-iconic-font.min.css"/>
    </style>
    <style type="text/css">
        <jsp:include page="/WEB-INF/pages/profil/vendor/font-awesome-4.7/css/font-awesome.min.css"/>
    </style>
    <!-- Icons font CSS-->
    ...
    <style type="text/css">
        <jsp:include page="/WEB-INF/pages/administrator/vendor/select2/select2.min.css"/>
    </style>
    <style type="text/css">
        <jsp:include page="/WEB-INF/pages/administrator/vendor/datepicker/daterangepicker.css"/>
    </style>
    ...
    <!-- Main CSS-->
    <style type="text/css">
        <jsp:include page="/WEB-INF/pages/profil/css/main.css"/>
    </style>
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <h2 class="title">HOME - Manage Users</h2>
